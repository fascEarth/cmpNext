...
export default async function login(req, res) {
  ...
  async function tftsendCodeToUser(req, res) {
    try {
      ...
      const rdata = await postPyApi('internal/email_sms_code', JSON.stringify(data)); // call your api function
  ...
  async function loginUser(req, res) {
    try {
      ...
      const rdata = await postPyApi('login', JSON.stringify({ ...data, password:encryptedPassword })); // call your api function
